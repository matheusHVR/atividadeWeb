...
function lista_enderecos(){
    ...
    $query = "SELECT enderecos.id as id, estados.nome as estado, cidades.nome as cidade, rua, numero, bairro, telefone from estados, cidades, enderecos WHERE enderecos.cidade_id = cidades.id and cidades.estado_id = estados.id ;";
